...
class GPR:
    ...
    def predict(self,at_values_y, var=False, std=False):
        ...
        sigma_k = self.calculate_covariance_matrix(self.z_train, at_values_y, self.kernel)
        sigma_kk = self.calculate_covariance_matrix(at_values_y, at_values_y, self.kernel)
